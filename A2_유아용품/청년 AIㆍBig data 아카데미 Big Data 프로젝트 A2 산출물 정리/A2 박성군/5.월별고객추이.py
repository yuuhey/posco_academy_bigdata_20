...
df_new['재구매_구매금액'] = [i[i.apply(lambda x:x['재구매여부'] == True, axis=1)]['구매금액'].sum() for i in customer_list]
df_new['재구매_평균구매금액'] = df_new['재구매_구매금액']/df_new['재구매고객수']
df_new['신규_평균구매금액'] = df_new['신규_구매금액']/df_new['신규고객수']
## 결제금액
df_new['신규_결제금액'] = [i[i.apply(lambda x:x['신규여부'] == True, axis=1)]['결제금액'].sum() for i in customer_list]
df_new['재구매_결제금액'] = [i[i.apply(lambda x:x['재구매여부'] == True, axis=1)]['결제금액'].sum() for i in customer_list]
df_new['재구매_평균결제금액'] = df_new['재구매_결제금액']/df_new['재구매고객수']
df_new['신규_평균결제금액'] = df_new['신규_결제금액']/df_new['신규고객수']
